...
def predict_model(model_choice, data_str, target_column):
    try:
        ...
        if response.status_code == 200:
            ...
            return predictions, y_true, accuracy, class_report, cm, fpr, tpr, roc_auc, task_id, task_url
        else:
        ...
        if model_choice is not None:
                    ...
                    try:
                        ...
                        if response.status_code == 200:
                            ...
                            if task_id:
                                ...
                                st.write(f" Training results URL on Clear Ml: {task_url}")
                        else:
            ...
            if st.button("Make Prediction"):
                with st.spinner(f'Making predictions with {model_choice}...'):
                    predictions, y_true, accuracy, class_report, cm, fpr, tpr, roc_auc, task_id, task_url = predict_model(model_choice, data_str, target_column)
